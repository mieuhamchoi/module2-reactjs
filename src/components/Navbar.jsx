        ...
        <div className="logos">
          ...
          >
            ...
            <span
              ...
              className="logo_menu_btn-text"
            >
              {t("category")}
            </span>
            {/* Menu bar */}
            <div
              style={{ backgroundColor: menuPopColor }}
              className={`menu_pops ${openMenu ? "show" : ""}`}
            >
              <Row
                gutter={{
                  xs: 8,
                        ...
                        {session.sessionHomeWork.map((homeWork, index) => (
                          <li key={session.sessionNumber + index}>
                            <Link
                              ...
                              className="session-sub-text dropdown-item"
                              to={homeWork.path}
                            >
                              {homeWork.name}
                            </Link>
