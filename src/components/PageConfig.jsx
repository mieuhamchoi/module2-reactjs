        ...
        [
            {
                id: 0,
                name: 'Việt Nam (Vi)',
                iconUrl: 'https://api.mieuhamchoi.fun/uploads/picture/subject/1686729520612-858194286.png',
                code: 'vi'
            },
            {
                id: 1,
                name: 'English (EN)',
                iconUrl: 'https://api.mieuhamchoi.fun/uploads/picture/subject/1686729520611-991329899.png',
                code: 'en'
            }
        ]
    );
            ...
            <ul className="dropdown-menu">
                {
                    languages.map((language) => 
                        ...
                        }} style={{cursor: "pointer"}} key={uuidv4()}>
